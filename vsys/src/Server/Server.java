...
private int counter = 0;	
	...
	/**
	 * Speichert Objektinstanzen sersialisiert auf der Platte ab
	 */
	/*private boolean serialisiere(String typ, String xml){	
		
		try {
						
		Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(typ+"_"+System.currentTimeMillis()+".xml"), StandardCharsets.UTF_8));
		writer.write(xml);
		writer.close();
