...
// 		Label erzeugen
		add(l1 = new JLabel ("C-F = "));
		l1.setBounds (70,30, 70, 20);
		add(l2 = new JLabel ("F-C = "));
		l2.setBounds (70,110, 70, 20);
// 		Button erzeugen
		add (b1 = new JButton ("C -> F"));
		b1.setBounds (40,70, 90,20);
		add (b2 = new JButton ("F -> C"));
...
//				t2.setText(wertKW +"");
				...
				f = (c * 9/5) + 32;
				formatOutput = String.format("%.1f", f);
				formatOutput = formatOutput.replace(",",".");
				t2.setText(formatOutput+"");
				break;
			case 2:  
				s = t2.getText(); 
...
//				t1.setText(wertPS +"");
				...
				c = (f - 32)*5/9;
				formatOutput = String.format("%.1f", c);
				formatOutput = formatOutput.replace(",",".");
				t1.setText(formatOutput+"");
			}
		 }
	}
