...
/*
 * ein einfaches java-programm zur Berechnung 2 Vektoren mit einfacher Operationen wie Addition,
 * Substraktion, Berechnung der Skalarprodukt des Einheitsvektor.
 * Falls die Dimension 3 ist, hat der Benutzer möghlickeit Vektorprodukt.
 * Die 3. Vektor mit Dimension 3 wird eingegeben, wenn der Benutzer die Spatprodukt berechnen möchte.
...
public class Vektortest {
    ...
    public static void main(String[] args) {
         ...
         * <br \> wenn die Zahl klener als 1 oder größer als 7, wird der Benutzer noch einmal gefragt.*/
        while(b1==false){
        ...
        Boolean b2=false;
        while(b2==false){
            int j = IOTools.readInteger("\nWählen Sie eine der folgenden Menu aus:\n"
                    + "(1) Länge der beiden vektoren berechnen\n"
